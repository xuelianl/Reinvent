# /pubhome/xli02/opt/miniconda/envs/reinvent.v3.2/lib/python3.7/site-packages/reinvent_scoring/scoring/enums/scoring_function_component_enum.py
...
class ScoringFunctionComponentNameEnum:
    ...
    SHAPE_SIMILARITY = "shape_similarity" # add by xli 20230228
    ICOLOS = "icolos"
