# /pubhome/xli02/opt/miniconda/envs/reinvent.v3.2/lib/python3.7/site-packages/reinvent_scoring/scoring/score_components/score_component_factory.py
...
from reinvent_scoring.scoring.score_components import TanimotoSimilarity, \
    ...
    LinkerNumHBD, LinkerMolWeight, LinkerRatioRotatableBonds, DockStream, NumAromaticRings, NumAliphaticRings, ShapeSimilarity # add by xli 20230228
...
class ScoreComponentFactory:
    ...
    def _deafult_scoring_component_registry(self) -> dict:
        ...
        component_map = {
            ...
            enum.SHAPE_SIMILARITY: ShapeSimilarity,  # add by xli 20230228
            enum.ICOLOS: Icolos,
    ...
    def create_score_components(self) -> [BaseScoreComponent]:
        def create_component(component_params):
            if component_params.component_type in self._current_components:
                ...
                component_instance = component(component_params) # dockstream.py, qed.py
            else:
